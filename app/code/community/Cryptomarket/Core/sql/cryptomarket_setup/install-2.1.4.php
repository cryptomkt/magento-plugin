 ...
 */
$this->run(sprintf('DROP TABLE IF EXISTS `%s`;', $this->getTable('cryptomarket/payorder')));
$ipnTable = new Varien_Db_Ddl_Table();
$ipnTable->setName($this->getTable('cryptomarket/payorder'));
 ...
 */
$this->run(sprintf('DROP TABLE IF EXISTS `%s`;', $this->getTable('cryptomarket/invoice')));
$invoiceTable = new Varien_Db_Ddl_Table();
$invoiceTable->setName($this->getTable('cryptomarket/invoice'));
